...
INSERT INTO Notices (Title, DateBinary, [Text], Duration, IsImportant) VALUES 
('Тестове огололення 1', -8586653617656125459, 'Якийсь текст оголошення', 100, 0),
('Тестове огололення 2', -8586653617656125459, 'Якийсь текст оголошення', 100, 0),
('Тестове огололення 3', -8586653617656125459, 'Якийсь текст оголошення', 100, 0),
('Тестове огололення 4', -8586653617656125459, 'Якийсь текст оголошення', 100, 0),
('Тестове огололення 5', -8586653617656125459, 'Текст важливого оголошення, дуже дуже, треба більше букв, і ще і ще', 100, 1),
('Тестове огололення 6', -8586653617656125459, 'Ну просто дуже важливе оголошення', 100, 1);